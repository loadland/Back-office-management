      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="注册与访问" name="first">
          ...
          <el-form-item label="密码最小长度">
            <el-input v-model="form.password_min" type="number" style="width: 30%;" />
          </el-form-item>
          <!-- 强制密码复杂度 -->
        ...
        <el-tab-pane label="上传设置">
          ...
          <el-form-item label="Bucket">
            <el-input v-model="form.upload_config.Bucket" style="width: 30%;" placeholder="Bucket" />
          </el-form-item>
          <!-- ACCESS_KEY -->
          <el-form-item label="ACCESS_KEY">
            <el-input v-model="form.upload_config.ACCESS_KEY" style="width: 30%;" placeholder="ACCESS_KEY" />
          </el-form-item>
          <!-- SECRET_KEY -->
          <el-form-item label="SECRET_KEY">
            <el-input v-model="form.upload_config.SECRET_KEY" style="width: 30%;" placeholder="SECRET_KEY" />
          </el-form-item>
          <!-- http -->
          <el-form-item label="http">
            <el-input v-model="form.upload_config.http" style="width: 30%;" placeholder="http" />
            <small class="text-gray-500 flex ml-3"> 请补全http:// 或 https:// </small>
          </el-form-item>
        </el-tab-pane>
        ...
        <el-tab-pane label="Api安全">
          ...
          <el-form-item label="秘钥">
            <div>
              <el-input v-model="form.api_secret" style="width: 40%;" placeholder="请输入秘钥" show-password />
              <small class="text-gray-500 flex mt-1">秘钥设置关系系统中api调用传输签名串的编码规则，以及会员token解析，请慎重设置，注意设置之后对应会员要求重新登录获取token
              </small>
            </div>
          </el-form-item>
        </el-tab-pane>
