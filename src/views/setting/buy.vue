        ...
        <el-tab-pane label="购物设置">
          ...
          <el-form-item label="未支付订单">
            <div>
              ...
              <small class="text-gray-500 flex ml-3">订单下单未付款，n分钟后自动关闭，设置0不自动关闭</small>
            </div>
          </el-form-item>
          <!-- 已发货订单 -->
          ...
          <el-form-item class="mt-5">
            <el-button type="primary" size="default" @click="onSubmit" :loading="loading">保存</el-button>
          </el-form-item>
        </el-tab-pane>
      </el-tabs>


      <formDrawer ref="formDrawerRef" title="配置">
        <template #form>
          <!-- 支付宝支付 -->
          <el-form v-if="drawerType == 'alipay'" :model="form" label-width="120px">
            ...
            <el-form-item label="ali_public_key">
              <el-input v-model="form.alipay.ali_public_key" style="width:90%;" type="textarea" rows="4"
                placeholder="ali_public_key"></el-input>
            </el-form-item>
            <el-form-item label="private_key">
              <el-input v-model="form.alipay.private_key" style="width:90%;" type="textarea" rows="4"
          ...
          <el-form v-else :model="form" label-width="120px">
            <el-form-item label="公众号 APPID">
              <el-input v-model="form.wxpay.app_id" style="width:90%;" placeholder="公众号 APPID"></el-input>
            </el-form-item>
            <el-form-item label="小程序 APPID">
              <el-input v-model="form.wxpay.miniapp_id" style="width:90%;" placeholder="小程序 APPID">
              </el-input>
            </el-form-item>
            <el-form-item label="小程序 secret">
              <el-input v-model="form.wxpay.secret" style="width:90%;" placeholder="小程序 secret">
              </el-input>
            </el-form-item>
            <el-form-item label="appid">
              <el-input v-model="form.wxpay.appid" style="width:90%;" placeholder="appid">
              </el-input>
            </el-form-item>
            <el-form-item label="商户号">
              <el-input v-model="form.wxpay.mch_id" style="width:90%;" placeholder="商户号">
              </el-input>
            </el-form-item>
            <el-form-item label="API 密钥">
              <el-input v-model="form.wxpay.key" style="width:90%;" placeholder="API 密钥">
              </el-input>
            </el-form-item>
            <el-form-item label="cert_client">
              <el-upload action="uploadURL" :headers="{ token }" accept=".pem" :limit="1"
...
const uploadURL = ref(import.meta.env.VITE_APP_BASE_API + '/sysconfig/upload')
